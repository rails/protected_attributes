...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency "activemodel",  ">= 4.0.1.rc1", "< 5.0"

  gem.add_development_dependency "activerecord", ">= 4.0.1.rc1", "< 5.0"
  gem.add_development_dependency "actionpack",   ">= 4.0.1.rc1", "< 5.0"
